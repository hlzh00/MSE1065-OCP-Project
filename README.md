...
Some entries are missing structural data, which are these columns: 
- density
- vpa
- packing fraction
- spacegroup_num
...
I think it will be good to go through each descriptor and decide whether it is a "good" descriptor based on domain knowledge. This can make our report stronger. Similarly, we can also see if there any other descriptors not implemented that would be fitting for this task.
